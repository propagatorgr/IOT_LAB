...
def inputNumber(message):
  while True:
    try:
       ...
       print("Δώστε ακέραιο! Ξαναπροσπαθήστε.")
       continue
    else:
       return userInput 
       break 
...
category_num=inputNumber("Δώσε μια από τις παραπάνω κατηγορίες νέων, γράφοντας τον αντίστοιχο αριθμό: ")
cat_key=str(category_num)

for i in range(len(Nooznews['entries'])):
  if Nooznews["entries"][i]["category"]==categories[cat_key]:  
